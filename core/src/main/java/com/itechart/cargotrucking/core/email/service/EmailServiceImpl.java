...
public class EmailServiceImpl implements EmailService {
    ...
    @Override
    public void sendAdminInfo(ClientAddDto clientAddDto, String pass) {
        SimpleMailMessage mailMessage = new SimpleMailMessage();
        mailMessage.setTo(clientAddDto.getAdminInfo().getEmail());
        mailMessage.setSubject("Your personal info");
        mailMessage.setText(String.format("Hello! You have %s administrator privileges\nYour login - %s\nYour password - %s",
                clientAddDto.getName(), clientAddDto.getAdminInfo().getLogin(), pass));
